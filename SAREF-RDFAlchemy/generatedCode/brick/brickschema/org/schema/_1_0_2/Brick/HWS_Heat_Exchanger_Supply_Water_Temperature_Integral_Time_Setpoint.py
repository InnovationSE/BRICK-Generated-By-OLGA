...
class HWS_Heat_Exchanger_Supply_Water_Temperature_Integral_Time_Setpoint(Heat_Exchanger_Discharge_Water_Temperature_Integral_Time_Setpoint,HWS_Heat_Exchanger_Supply_Water_Temperature_Setpoint,HWS_Heat_Exchanger_Discharge_Water_Temperature_Setpoint,Heat_Exchanger_Supply_Water_Temperature_Integral_Time_Setpoint,Supply_Water_Temperature_Integral_Time_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').HWS_Heat_Exchanger_Supply_Water_Temperature_Integral_Time_Setpoint

...
class CWS_Chilled_Water_Supply_Temperature_Sensor(Supply_Water_Temperature_Sensor,Chilled_Water_Discharge_Temperature_Sensor,Chilled_Water_Supply_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').CWS_Chilled_Water_Supply_Temperature_Sensor

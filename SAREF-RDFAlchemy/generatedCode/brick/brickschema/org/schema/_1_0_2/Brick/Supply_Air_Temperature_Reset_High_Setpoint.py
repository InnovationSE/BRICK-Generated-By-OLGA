...
class Supply_Air_Temperature_Reset_High_Setpoint(Discharge_Air_Temperature_Setpoint,Reset_Setpoint,Supply_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Temperature_Reset_High_Setpoint

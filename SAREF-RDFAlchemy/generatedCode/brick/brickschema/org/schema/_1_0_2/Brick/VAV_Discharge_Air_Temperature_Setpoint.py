...
class VAV_Discharge_Air_Temperature_Setpoint(Supply_Air_Temperature_Setpoint,Discharge_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Discharge_Air_Temperature_Setpoint

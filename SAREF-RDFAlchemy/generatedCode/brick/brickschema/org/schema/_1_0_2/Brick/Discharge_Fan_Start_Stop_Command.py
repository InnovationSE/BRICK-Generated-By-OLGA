...
class Discharge_Fan_Start_Stop_Command(Discharge_Fan_Command,Start_Stop_Command,Supply_Fan_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Fan_Start_Stop_Command

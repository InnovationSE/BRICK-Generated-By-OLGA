...
class VAV_Discharge_Air_Flow_Setpoint(Discharge_Air_Flow_Setpoint,Supply_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Discharge_Air_Flow_Setpoint

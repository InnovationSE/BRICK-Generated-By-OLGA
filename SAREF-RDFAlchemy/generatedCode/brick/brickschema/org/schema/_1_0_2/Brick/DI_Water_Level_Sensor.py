...
class DI_Water_Level_Sensor(DI_Water,Water_Level_Sensor,Deionised_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').DI_Water_Level_Sensor

...
class AHU_Discharge_Fan_VFD_Speed_Setpoint(Discharge_Fan_VFD_Speed_Setpoint,Supply_Fan_VFD_Speed_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Fan_VFD_Speed_Setpoint

...
class VAV_Occupied_Heating_Max_Supply_Air_Flow_Setpoint(Occupied_Heating_Max_Supply_Air_Flow_Setpoint,Occupied_Heating_Max_Discharge_Air_Flow_Setpoint,VAV_Heating_Max_Discharge_Air_Flow_Setpoint,VAV_Occupied_Heating_Discharge_Air_Flow_Setpoint,Occupied_Heating_Discharge_Air_Flow_Setpoint,VAV_Occupied_Heating_Supply_Air_Flow_Setpoint,VAV_Heating_Max_Supply_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Occupied_Heating_Max_Supply_Air_Flow_Setpoint

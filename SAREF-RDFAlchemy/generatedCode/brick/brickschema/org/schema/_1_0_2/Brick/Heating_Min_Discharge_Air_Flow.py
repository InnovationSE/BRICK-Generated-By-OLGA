...
class Heating_Min_Discharge_Air_Flow(Heating_Discharge_Air_Flow,Min_Air_Flow):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Heating_Min_Discharge_Air_Flow

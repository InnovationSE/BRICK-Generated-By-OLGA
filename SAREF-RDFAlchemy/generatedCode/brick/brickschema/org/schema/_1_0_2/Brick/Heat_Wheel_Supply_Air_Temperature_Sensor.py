...
class Heat_Wheel_Supply_Air_Temperature_Sensor(Supply_Air_Temperature_Sensor,Discharge_Air_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Heat_Wheel_Supply_Air_Temperature_Sensor

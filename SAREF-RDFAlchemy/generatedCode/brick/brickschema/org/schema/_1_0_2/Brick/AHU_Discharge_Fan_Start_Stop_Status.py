...
class AHU_Discharge_Fan_Start_Stop_Status(Discharge_Fan_Start_Stop_Status,AHU_Discharge_Fan_Status,AHU_Fan_Start_Stop_Status,AHU_Supply_Fan_Status,Supply_Fan_Start_Stop_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Fan_Start_Stop_Status

...
class VAV_Occupied_Cooling_Discharge_Air_Flow_Setpoint(VAV_Supply_Air_Flow_Setpoint,Occupied_Cooling_Discharge_Air_Flow_Setpoint,VAV_Discharge_Air_Flow_Setpoint,Occupied_Cooling_Supply_Air_Flow_Setpoint,Cooling_Discharge_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Occupied_Cooling_Discharge_Air_Flow_Setpoint

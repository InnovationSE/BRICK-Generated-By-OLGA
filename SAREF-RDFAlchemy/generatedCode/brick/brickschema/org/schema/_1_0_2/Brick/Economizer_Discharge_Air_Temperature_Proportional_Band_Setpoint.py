...
class Economizer_Discharge_Air_Temperature_Proportional_Band_Setpoint(Proportional_Band_Setpoint,Discharge_Air_Temperature_Setpoint,Supply_Air_Temperature_Setpoint,Economizer_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Economizer_Discharge_Air_Temperature_Proportional_Band_Setpoint

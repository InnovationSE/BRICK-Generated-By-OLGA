...
class AHU_Supply_Air_Temperature_Reset_Differential_Setpoint(Supply_Air_Temperature_Reset_Differential_Setpoint,AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint,Discharge_Air_Temperature_Reset_Differential_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Air_Temperature_Reset_Differential_Setpoint

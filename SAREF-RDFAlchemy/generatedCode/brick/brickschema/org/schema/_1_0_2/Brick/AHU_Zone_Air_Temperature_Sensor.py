...
class AHU_Zone_Air_Temperature_Sensor(AHU_Zone_Temperature_Sensor,Zone_Air_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Zone_Air_Temperature_Sensor

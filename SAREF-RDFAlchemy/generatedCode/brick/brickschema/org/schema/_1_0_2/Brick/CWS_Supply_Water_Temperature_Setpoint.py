...
class CWS_Supply_Water_Temperature_Setpoint(Supply_Water_Temperature_Setpoint,Discharge_Water_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').CWS_Supply_Water_Temperature_Setpoint

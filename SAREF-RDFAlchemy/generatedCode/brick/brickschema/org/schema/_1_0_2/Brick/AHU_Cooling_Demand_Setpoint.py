...
class AHU_Cooling_Demand_Setpoint(Demand_Setpoint,Cooling_Request_Setpoint,Cooling_Demand_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Cooling_Demand_Setpoint

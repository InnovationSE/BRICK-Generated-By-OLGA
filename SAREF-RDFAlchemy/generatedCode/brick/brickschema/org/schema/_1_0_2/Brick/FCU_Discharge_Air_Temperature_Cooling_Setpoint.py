...
class FCU_Discharge_Air_Temperature_Cooling_Setpoint(Supply_Air_Temperature_Cooling_Setpoint,FCU_Discharge_Air_Temperature_Setpoint,Discharge_Air_Temperature_Cooling_Setpoint,FCU_Supply_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').FCU_Discharge_Air_Temperature_Cooling_Setpoint

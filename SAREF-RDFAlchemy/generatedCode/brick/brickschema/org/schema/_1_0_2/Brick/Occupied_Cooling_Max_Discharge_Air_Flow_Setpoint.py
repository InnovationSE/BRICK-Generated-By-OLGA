...
class Occupied_Cooling_Max_Discharge_Air_Flow_Setpoint(Cooling_Max_Discharge_Air_Flow_Setpoint,Cooling_Max_Supply_Air_Flow_Setpoint,Occupied_Cooling_Supply_Air_Flow_Setpoint,Occupied_Cooling_Discharge_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Occupied_Cooling_Max_Discharge_Air_Flow_Setpoint

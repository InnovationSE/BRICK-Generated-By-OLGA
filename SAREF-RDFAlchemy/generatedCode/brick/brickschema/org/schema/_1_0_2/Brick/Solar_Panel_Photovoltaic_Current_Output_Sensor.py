...
class Solar_Panel_Photovoltaic_Current_Output_Sensor(PV_Current_Output_Sensor,Photovoltaic_Current_Output_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Solar_Panel_Photovoltaic_Current_Output_Sensor

...
class VAV_Discharge_Air_Duct_Pressure_Status(Discharge_Air_Duct_Pressure_Status,Supply_Air_Duct_Pressure_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Discharge_Air_Duct_Pressure_Status

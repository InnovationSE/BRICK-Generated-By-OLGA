...
class AHU_Discharge_Air_Temperature_Setpoint_Increase_Decrease_Step(AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint,Supply_Air_Temperature_Setpoint_Increase_Decrease_Step,Discharge_Air_Temperature_Setpoint_Increase_Decrease_Step):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Temperature_Setpoint_Increase_Decrease_Step

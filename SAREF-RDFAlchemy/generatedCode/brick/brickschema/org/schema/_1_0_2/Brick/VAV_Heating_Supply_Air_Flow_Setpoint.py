...
class VAV_Heating_Supply_Air_Flow_Setpoint(VAV_Supply_Air_Flow_Setpoint,Heating_Supply_Air_Flow_Setpoint,Heating_Discharge_Air_Flow_Setpoint,Discharge_Air_Flow_Setpoint,VAV_Discharge_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Heating_Supply_Air_Flow_Setpoint

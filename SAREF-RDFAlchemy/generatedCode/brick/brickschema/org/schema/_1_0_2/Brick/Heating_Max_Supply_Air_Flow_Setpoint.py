...
class Heating_Max_Supply_Air_Flow_Setpoint(Heating_Discharge_Air_Flow_Setpoint,Heating_Supply_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Heating_Max_Supply_Air_Flow_Setpoint

...
class Chilled_Water_Static_Pressure_Setpoint(Static_Pressure_Setpoint,Chilled_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Chilled_Water_Static_Pressure_Setpoint

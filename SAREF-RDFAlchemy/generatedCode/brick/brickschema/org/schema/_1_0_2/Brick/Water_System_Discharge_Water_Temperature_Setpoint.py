...
class Water_System_Discharge_Water_Temperature_Setpoint(Discharge_Water_Temperature_Setpoint,Supply_Water_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Water_System_Discharge_Water_Temperature_Setpoint

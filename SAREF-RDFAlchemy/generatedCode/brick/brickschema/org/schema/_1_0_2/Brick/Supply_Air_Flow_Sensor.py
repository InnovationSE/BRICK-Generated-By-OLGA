...
class Supply_Air_Flow_Sensor(Discharge_Air,Supply_Air,Air_Flow_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Flow_Sensor

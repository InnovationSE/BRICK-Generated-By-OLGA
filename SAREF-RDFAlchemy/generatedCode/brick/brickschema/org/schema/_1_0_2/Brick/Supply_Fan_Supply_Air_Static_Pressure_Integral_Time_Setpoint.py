...
class Supply_Fan_Supply_Air_Static_Pressure_Integral_Time_Setpoint(Supply_Air_Static_Pressure_Integral_Time_Setpoint,Discharge_Air_Static_Pressure_Integral_Time_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Fan_Supply_Air_Static_Pressure_Integral_Time_Setpoint

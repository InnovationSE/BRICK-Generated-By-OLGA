...
class Exhaust_Air_Static_Pressure_Sensor(Exhaust_Air,Static_Pressure_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Exhaust_Air_Static_Pressure_Sensor

...
class Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Setpoint(Discharge_Water_Temperature_Setpoint,Medium_Temperature_Hot_Water,Load_Shed_Supply_Water_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Setpoint

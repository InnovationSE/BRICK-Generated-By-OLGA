...
class VAV_Discharge_Air_Flow_Command(Discharge_Air_Flow_Command,Supply_Air_Flow_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Discharge_Air_Flow_Command

...
class Temperature_Tolerance_Setpoint(Tolerance_Setpoint,Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Temperature_Tolerance_Setpoint

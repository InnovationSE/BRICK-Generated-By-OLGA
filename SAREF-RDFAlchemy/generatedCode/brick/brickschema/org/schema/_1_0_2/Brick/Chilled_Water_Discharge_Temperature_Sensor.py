...
class Chilled_Water_Discharge_Temperature_Sensor(Water_Supply_Temperature_Sensor,Chilled_Water,Supply_Water_Temperature_Sensor,Water_Discharge_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Chilled_Water_Discharge_Temperature_Sensor

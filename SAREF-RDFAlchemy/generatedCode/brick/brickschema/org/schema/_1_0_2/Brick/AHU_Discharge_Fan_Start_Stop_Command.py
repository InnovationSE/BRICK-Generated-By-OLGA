...
class AHU_Discharge_Fan_Start_Stop_Command(Supply_Fan_Start_Stop_Command,AHU_Discharge_Fan_Command,AHU_Supply_Fan_Command,Discharge_Fan_Start_Stop_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Fan_Start_Stop_Command

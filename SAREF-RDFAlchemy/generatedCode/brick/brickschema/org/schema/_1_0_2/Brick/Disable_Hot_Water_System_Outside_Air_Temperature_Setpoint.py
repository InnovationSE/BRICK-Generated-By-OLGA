...
class Disable_Hot_Water_System_Outside_Air_Temperature_Setpoint(Outside_Air,Temperature_Setpoint,Hot_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Disable_Hot_Water_System_Outside_Air_Temperature_Setpoint

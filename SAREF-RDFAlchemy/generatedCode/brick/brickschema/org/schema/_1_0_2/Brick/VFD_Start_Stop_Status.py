...
class VFD_Start_Stop_Status(Start_Stop_Status,VFD_Status,On_Off_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VFD_Start_Stop_Status

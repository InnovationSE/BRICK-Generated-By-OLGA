...
class Economizer_Supply_Air_Temperature_Dead_Band_Setpoint(Dead_Band_Setpoint,Discharge_Air_Temperature_Setpoint,Supply_Air_Temperature_Setpoint,Economizer_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Economizer_Supply_Air_Temperature_Dead_Band_Setpoint

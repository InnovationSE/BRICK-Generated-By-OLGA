...
class AHU_Supply_Fan_Command(Supply_Fan_Command,Discharge_Fan_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Fan_Command

...
class Supply_Air_Temperature_Cooling(Supply_Air_Temperature,Cooling_Temperature):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Temperature_Cooling

...
class Cooling_Min_Supply_Air_Flow_Setpoint(Cooling_Discharge_Air_Flow_Setpoint,Supply_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Cooling_Min_Supply_Air_Flow_Setpoint

...
class Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint(Hot_Water_Supply_Temperature_Low_Reset_Setpoint,Medium_Temperature_Hot_Water,Discharge_Water_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint

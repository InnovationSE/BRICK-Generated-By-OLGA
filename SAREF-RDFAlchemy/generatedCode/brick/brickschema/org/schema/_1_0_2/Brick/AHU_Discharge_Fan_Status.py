...
class AHU_Discharge_Fan_Status(Discharge_Fan_Status,Supply_Fan_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Fan_Status

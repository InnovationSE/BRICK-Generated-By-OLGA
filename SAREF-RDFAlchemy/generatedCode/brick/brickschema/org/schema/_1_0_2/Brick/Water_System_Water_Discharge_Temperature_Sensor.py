...
class Water_System_Water_Discharge_Temperature_Sensor(Water_Discharge_Temperature_Sensor,Water_Supply_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Water_System_Water_Discharge_Temperature_Sensor

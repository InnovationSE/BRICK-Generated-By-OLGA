...
class Exhaust_Air_Velocity_Pressure_Sensor(Velocity_Pressure_Sensor,Exhaust_Air):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Exhaust_Air_Velocity_Pressure_Sensor

...
class AHU_Max_Supply_Air_Static_Pressure_Setpoint(Max_Discharge_Air_Static_Pressure_Setpoint,Discharge_Air_Static_Pressure_Setpoint,Max_Supply_Air_Static_Pressure_Setpoint,AHU_Discharge_Air_Static_Pressure_Setpoint,AHU_Supply_Air_Static_Pressure_Setpoint,AHU_Static_Pressure_Max_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Max_Supply_Air_Static_Pressure_Setpoint

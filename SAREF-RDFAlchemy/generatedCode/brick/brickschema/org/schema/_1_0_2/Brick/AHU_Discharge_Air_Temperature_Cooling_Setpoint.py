...
class AHU_Discharge_Air_Temperature_Cooling_Setpoint(Discharge_Air_Temperature_Cooling_Setpoint,Supply_Air_Temperature_Cooling_Setpoint,AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Temperature_Cooling_Setpoint

...
class Supply_Fan_Supply_Air_Proportional_Gain_Factor(Proportional_Gain_Setpoint,Supply_Air_Proportional_Gain_Factor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Fan_Supply_Air_Proportional_Gain_Factor

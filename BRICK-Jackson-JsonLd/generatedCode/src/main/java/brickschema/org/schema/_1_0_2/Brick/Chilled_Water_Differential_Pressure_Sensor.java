...
public  class Chilled_Water_Differential_Pressure_Sensor implements IChilled_Water_Differential_Pressure_Sensor {

	Map<String, List<RefId>> relations;
	
	public Chilled_Water_Differential_Pressure_Sensor(String id) {
		super();
	...
	{
		return "https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Differential_Pressure_Sensor";
	}

...
import brickschema.org.schema._1_0_2.Brick.Hot_Water_Pump_Status;
...
public  class HWS_Hot_Water_Pump_Status implements IHWS_Hot_Water_Pump_Status {

	IRI newInstance;
	
	public HWS_Hot_Water_Pump_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#HWS_Hot_Water_Pump_Status"));
	}

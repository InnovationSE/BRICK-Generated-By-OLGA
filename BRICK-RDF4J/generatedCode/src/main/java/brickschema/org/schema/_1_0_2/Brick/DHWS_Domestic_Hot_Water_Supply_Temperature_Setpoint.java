...
public  class DHWS_Domestic_Hot_Water_Supply_Temperature_Setpoint implements IDHWS_Domestic_Hot_Water_Supply_Temperature_Setpoint {

	IRI newInstance;
	
	public DHWS_Domestic_Hot_Water_Supply_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#DHWS_Domestic_Hot_Water_Supply_Temperature_Setpoint"));
	}

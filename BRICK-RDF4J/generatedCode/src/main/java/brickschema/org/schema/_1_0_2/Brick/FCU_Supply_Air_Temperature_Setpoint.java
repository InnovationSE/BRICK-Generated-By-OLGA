...
public  class FCU_Supply_Air_Temperature_Setpoint implements IFCU_Supply_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public FCU_Supply_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#FCU_Supply_Air_Temperature_Setpoint"));
	}

...
public  class Air_Lockout_Temperature implements IAir_Lockout_Temperature {

	IRI newInstance;
	
	public Air_Lockout_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Air_Lockout_Temperature"));
	}

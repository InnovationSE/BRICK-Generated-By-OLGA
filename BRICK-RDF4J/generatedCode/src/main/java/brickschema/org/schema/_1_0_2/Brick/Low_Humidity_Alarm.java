...
public  class Low_Humidity_Alarm implements ILow_Humidity_Alarm {

	IRI newInstance;
	
	public Low_Humidity_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Low_Humidity_Alarm"));
	}

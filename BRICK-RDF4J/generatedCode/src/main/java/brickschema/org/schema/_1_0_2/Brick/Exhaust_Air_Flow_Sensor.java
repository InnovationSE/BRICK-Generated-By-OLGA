...
public  class Exhaust_Air_Flow_Sensor implements IExhaust_Air_Flow_Sensor {

	IRI newInstance;
	
	public Exhaust_Air_Flow_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Exhaust_Air_Flow_Sensor"));
	}

...
public  class DemandResponse_Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Status implements IDemandResponse_Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Status {
	...
	public DemandResponse_Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#DemandResponse_Medium_Temperature_Hot_Water_Supply_Temperature_Load_Shed_Status"));
	}

...
public  class Chilled_Water_Pump_Lead_Lag implements IChilled_Water_Pump_Lead_Lag {

	IRI newInstance;
	
	public Chilled_Water_Pump_Lead_Lag(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Pump_Lead_Lag"));
	}

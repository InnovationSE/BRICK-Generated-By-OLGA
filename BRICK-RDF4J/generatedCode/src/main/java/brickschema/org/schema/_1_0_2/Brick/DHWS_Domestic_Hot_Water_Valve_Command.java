...
import brickschema.org.schema._1_0_2.Brick.Domestic_Hot_Water_Valve_Command;
...
public  class DHWS_Domestic_Hot_Water_Valve_Command implements IDHWS_Domestic_Hot_Water_Valve_Command {

	IRI newInstance;
	
	public DHWS_Domestic_Hot_Water_Valve_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#DHWS_Domestic_Hot_Water_Valve_Command"));
	}

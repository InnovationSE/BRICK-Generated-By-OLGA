...
public  class Domestic_Hot_Water_Discharge_Temperature_Setpoint implements IDomestic_Hot_Water_Discharge_Temperature_Setpoint {

	IRI newInstance;
	
	public Domestic_Hot_Water_Discharge_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Domestic_Hot_Water_Discharge_Temperature_Setpoint"));
	}

...
public  class HWS_Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint implements IHWS_Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint {

	IRI newInstance;
	
	public HWS_Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#HWS_Medium_Temperature_Hot_Water_Supply_Temperature_Low_Reset_Setpoint"));
	}

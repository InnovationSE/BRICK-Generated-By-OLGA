...
public  class AHU_Outside_Air_Temperature_Low_Reset_Setpoint implements IAHU_Outside_Air_Temperature_Low_Reset_Setpoint {

	IRI newInstance;
	
	public AHU_Outside_Air_Temperature_Low_Reset_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Outside_Air_Temperature_Low_Reset_Setpoint"));
	}

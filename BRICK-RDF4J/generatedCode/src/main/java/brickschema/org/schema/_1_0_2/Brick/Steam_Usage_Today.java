...
public  class Steam_Usage_Today implements ISteam_Usage_Today {

	IRI newInstance;
	
	public Steam_Usage_Today(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Steam_Usage_Today"));
	}

...
public  class Unoccupied_Cooling_Discharge_Air_Flow implements IUnoccupied_Cooling_Discharge_Air_Flow {

	IRI newInstance;
	
	public Unoccupied_Cooling_Discharge_Air_Flow(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Unoccupied_Cooling_Discharge_Air_Flow"));
	}

...
public  class Mixed_Air_Damper_Position_Command implements IMixed_Air_Damper_Position_Command {

	IRI newInstance;
	
	public Mixed_Air_Damper_Position_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Mixed_Air_Damper_Position_Command"));
	}

...
public  class Differential_Pressure_Setpoint implements IDifferential_Pressure_Setpoint {
	...
	public Differential_Pressure_Setpoint(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Differential_Pressure_Setpoint"));
	}

...
import brickschema.org.schema._1_0_2.Brick.Outside_Air_Flow_Sensor;
...
public  class AHU_Outside_Air_Flow_Sensor implements IAHU_Outside_Air_Flow_Sensor {

	IRI newInstance;
	
	public AHU_Outside_Air_Flow_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Outside_Air_Flow_Sensor"));
	}

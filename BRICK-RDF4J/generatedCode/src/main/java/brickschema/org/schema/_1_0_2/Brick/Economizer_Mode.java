...
public  class Economizer_Mode implements IEconomizer_Mode {
	...
	public Economizer_Mode(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Mode"));
	}

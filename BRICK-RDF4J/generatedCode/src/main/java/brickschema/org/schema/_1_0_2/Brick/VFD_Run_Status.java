...
public  class VFD_Run_Status implements IVFD_Run_Status {

	IRI newInstance;
	
	public VFD_Run_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#VFD_Run_Status"));
	}

...
public  class Open_Heating_Valve_Outside_Air_Temperature_Setpoint implements IOpen_Heating_Valve_Outside_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public Open_Heating_Valve_Outside_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Open_Heating_Valve_Outside_Air_Temperature_Setpoint"));
	}

...
public  class AHU_Exhaust_Fan_VFD_Speed_Command implements IAHU_Exhaust_Fan_VFD_Speed_Command {

	IRI newInstance;
	
	public AHU_Exhaust_Fan_VFD_Speed_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Exhaust_Fan_VFD_Speed_Command"));
	}

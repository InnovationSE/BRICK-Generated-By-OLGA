...
public  class Deionised_Water_Conductivity implements IDeionised_Water_Conductivity {

	IRI newInstance;
	
	public Deionised_Water_Conductivity(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Deionised_Water_Conductivity"));
	}

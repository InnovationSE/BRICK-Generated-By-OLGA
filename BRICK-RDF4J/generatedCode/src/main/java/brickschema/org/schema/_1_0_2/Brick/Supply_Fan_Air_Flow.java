...
public  class Supply_Fan_Air_Flow implements ISupply_Fan_Air_Flow {

	IRI newInstance;
	
	public Supply_Fan_Air_Flow(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Supply_Fan_Air_Flow"));
	}

...
public  class Exhaust_Air_Temperature implements IExhaust_Air_Temperature {

	IRI newInstance;
	
	public Exhaust_Air_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Exhaust_Air_Temperature"));
	}

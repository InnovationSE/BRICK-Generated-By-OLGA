...
import brickschema.org.schema._1_0_2.Brick.Discharge_Air_Flow_Reset_High_Setpoint;
...
public  class AHU_Discharge_Air_Flow_Reset_High_Setpoint implements IAHU_Discharge_Air_Flow_Reset_High_Setpoint {

	IRI newInstance;
	
	public AHU_Discharge_Air_Flow_Reset_High_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Discharge_Air_Flow_Reset_High_Setpoint"));
	}

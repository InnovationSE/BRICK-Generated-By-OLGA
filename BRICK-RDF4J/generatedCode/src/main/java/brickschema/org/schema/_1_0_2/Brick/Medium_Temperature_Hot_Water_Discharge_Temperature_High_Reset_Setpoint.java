...
public  class Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint implements IMedium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint {

	IRI newInstance;
	
	public Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint"));
	}

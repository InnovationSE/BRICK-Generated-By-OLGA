...
public  class System_Mode implements ISystem_Mode {

	IRI newInstance;
	
	public System_Mode(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#System_Mode"));
	}

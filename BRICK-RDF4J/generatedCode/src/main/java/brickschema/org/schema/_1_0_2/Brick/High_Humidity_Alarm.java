...
public  class High_Humidity_Alarm implements IHigh_Humidity_Alarm {

	IRI newInstance;
	
	public High_Humidity_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#High_Humidity_Alarm"));
	}

...
public  class Boiler_On_Off_Status implements IBoiler_On_Off_Status {

	IRI newInstance;
	
	public Boiler_On_Off_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Boiler_On_Off_Status"));
	}

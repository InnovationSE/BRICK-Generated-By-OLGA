...
public  class CWS_Chilled_Water_Supply_Temperature_Sensor implements ICWS_Chilled_Water_Supply_Temperature_Sensor {

	IRI newInstance;
	
	public CWS_Chilled_Water_Supply_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CWS_Chilled_Water_Supply_Temperature_Sensor"));
	}

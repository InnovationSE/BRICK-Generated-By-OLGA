...
public  class Disable_Hot_Water_System_Outside_Air_Temperature_Setpoint implements IDisable_Hot_Water_System_Outside_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public Disable_Hot_Water_System_Outside_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Disable_Hot_Water_System_Outside_Air_Temperature_Setpoint"));
	}

...
import brickschema.org.schema._1_0_2.Brick.Deionised_Water_Conductivity_Sensor;
...
public  class Water_System_Deionised_Water_Conductivity_Sensor implements IWater_System_Deionised_Water_Conductivity_Sensor {

	IRI newInstance;
	
	public Water_System_Deionised_Water_Conductivity_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Water_System_Deionised_Water_Conductivity_Sensor"));
	}

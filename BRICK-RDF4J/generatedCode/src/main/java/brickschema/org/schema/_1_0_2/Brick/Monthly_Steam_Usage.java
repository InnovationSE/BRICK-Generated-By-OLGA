...
public  class Monthly_Steam_Usage implements IMonthly_Steam_Usage {

	IRI newInstance;
	
	public Monthly_Steam_Usage(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Monthly_Steam_Usage"));
	}

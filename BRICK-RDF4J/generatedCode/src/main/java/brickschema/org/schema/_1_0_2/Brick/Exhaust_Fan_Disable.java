...
public  class Exhaust_Fan_Disable implements IExhaust_Fan_Disable {

	IRI newInstance;
	
	public Exhaust_Fan_Disable(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Exhaust_Fan_Disable"));
	}

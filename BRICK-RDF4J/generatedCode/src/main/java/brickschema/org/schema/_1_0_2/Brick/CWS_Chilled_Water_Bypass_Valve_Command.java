...
import brickschema.org.schema._1_0_2.Brick.Chilled_Water_Bypass_Valve_Command;
...
public  class CWS_Chilled_Water_Bypass_Valve_Command implements ICWS_Chilled_Water_Bypass_Valve_Command {

	IRI newInstance;
	
	public CWS_Chilled_Water_Bypass_Valve_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CWS_Chilled_Water_Bypass_Valve_Command"));
	}

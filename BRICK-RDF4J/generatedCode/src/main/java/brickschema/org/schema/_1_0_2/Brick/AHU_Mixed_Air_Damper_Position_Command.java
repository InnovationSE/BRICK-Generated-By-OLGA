...
import brickschema.org.schema._1_0_2.Brick.Mixed_Air_Damper_Position_Command;
...
public  class AHU_Mixed_Air_Damper_Position_Command implements IAHU_Mixed_Air_Damper_Position_Command {

	IRI newInstance;
	
	public AHU_Mixed_Air_Damper_Position_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Mixed_Air_Damper_Position_Command"));
	}

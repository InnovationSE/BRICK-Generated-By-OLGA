...
public  class DI_Water_Alarm implements IDI_Water_Alarm {

	IRI newInstance;
	
	public DI_Water_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#DI_Water_Alarm"));
	}

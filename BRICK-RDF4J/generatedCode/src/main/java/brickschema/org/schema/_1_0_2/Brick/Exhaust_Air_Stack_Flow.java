...
public  class Exhaust_Air_Stack_Flow implements IExhaust_Air_Stack_Flow {

	IRI newInstance;
	
	public Exhaust_Air_Stack_Flow(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Exhaust_Air_Stack_Flow"));
	}

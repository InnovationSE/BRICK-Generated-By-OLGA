...
public  class AHU_Return_Fan_Command implements IAHU_Return_Fan_Command {

	IRI newInstance;
	
	public AHU_Return_Fan_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Return_Fan_Command"));
	}

...
public  class Air_Damper_Position implements IAir_Damper_Position {

	IRI newInstance;
	
	public Air_Damper_Position(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Air_Damper_Position"));
	}

...
public  class Chilled_Water_Pump_VFD_Speed implements IChilled_Water_Pump_VFD_Speed {

	IRI newInstance;
	
	public Chilled_Water_Pump_VFD_Speed(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Pump_VFD_Speed"));
	}

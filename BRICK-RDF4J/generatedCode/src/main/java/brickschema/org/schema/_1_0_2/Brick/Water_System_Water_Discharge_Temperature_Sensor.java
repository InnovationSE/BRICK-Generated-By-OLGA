...
public  class Water_System_Water_Discharge_Temperature_Sensor implements IWater_System_Water_Discharge_Temperature_Sensor {

	IRI newInstance;
	
	public Water_System_Water_Discharge_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Water_System_Water_Discharge_Temperature_Sensor"));
	}

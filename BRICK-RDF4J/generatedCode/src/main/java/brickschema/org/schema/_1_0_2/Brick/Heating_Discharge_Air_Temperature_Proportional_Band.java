...
import brickschema.org.schema._1_0_2.Brick.Discharge_Air_Temperature_Heating;
...
public  class Heating_Discharge_Air_Temperature_Proportional_Band implements IHeating_Discharge_Air_Temperature_Proportional_Band {

	IRI newInstance;
	
	public Heating_Discharge_Air_Temperature_Proportional_Band(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Heating_Discharge_Air_Temperature_Proportional_Band"));
	}

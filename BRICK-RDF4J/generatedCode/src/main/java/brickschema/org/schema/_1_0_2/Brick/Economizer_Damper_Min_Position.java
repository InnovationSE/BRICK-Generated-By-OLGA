...
import brickschema.org.schema._1_0_2.Brick.Economizer_Damper;
...
public  class Economizer_Damper_Min_Position implements IEconomizer_Damper_Min_Position {

	IRI newInstance;
	
	public Economizer_Damper_Min_Position(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Damper_Min_Position"));
	}

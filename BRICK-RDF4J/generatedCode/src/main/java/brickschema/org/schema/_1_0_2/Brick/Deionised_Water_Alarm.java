...
public  class Deionised_Water_Alarm implements IDeionised_Water_Alarm {

	IRI newInstance;
	
	public Deionised_Water_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Deionised_Water_Alarm"));
	}

...
public  class Deionised_Water implements IDeionised_Water {

	IRI newInstance;
	
	public Deionised_Water(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Deionised_Water"));
	}

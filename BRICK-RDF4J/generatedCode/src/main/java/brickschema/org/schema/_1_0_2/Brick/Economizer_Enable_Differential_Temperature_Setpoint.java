...
public  class Economizer_Enable_Differential_Temperature_Setpoint implements IEconomizer_Enable_Differential_Temperature_Setpoint {
	...
	public Economizer_Enable_Differential_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Enable_Differential_Temperature_Setpoint"));
	}

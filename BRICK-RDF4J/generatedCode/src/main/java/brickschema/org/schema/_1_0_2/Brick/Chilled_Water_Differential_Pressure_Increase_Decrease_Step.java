...
public  class Chilled_Water_Differential_Pressure_Increase_Decrease_Step implements IChilled_Water_Differential_Pressure_Increase_Decrease_Step {

	IRI newInstance;
	
	public Chilled_Water_Differential_Pressure_Increase_Decrease_Step(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Differential_Pressure_Increase_Decrease_Step"));
	}

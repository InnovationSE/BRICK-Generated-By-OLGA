...
public  class Current_Steam_Usage implements ICurrent_Steam_Usage {

	IRI newInstance;
	
	public Current_Steam_Usage(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Current_Steam_Usage"));
	}

...
public  class Chilled_Water_Return_Temperature implements IChilled_Water_Return_Temperature {

	IRI newInstance;
	
	public Chilled_Water_Return_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Return_Temperature"));
	}

...
public  class Velocity_Pressure_Setpoint implements IVelocity_Pressure_Setpoint {

	IRI newInstance;
	
	public Velocity_Pressure_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Velocity_Pressure_Setpoint"));
	}

...
import brickschema.org.schema._1_0_2.Brick.Heating_Valve;
...
public  class Domestic_Hot_Water_Valve implements IDomestic_Hot_Water_Valve {

	IRI newInstance;
	
	public Domestic_Hot_Water_Valve(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Domestic_Hot_Water_Valve"));
	}

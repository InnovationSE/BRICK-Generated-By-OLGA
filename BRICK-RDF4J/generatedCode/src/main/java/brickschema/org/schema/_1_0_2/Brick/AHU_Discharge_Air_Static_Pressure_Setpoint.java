...
public  class AHU_Discharge_Air_Static_Pressure_Setpoint implements IAHU_Discharge_Air_Static_Pressure_Setpoint {

	IRI newInstance;
	
	public AHU_Discharge_Air_Static_Pressure_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Discharge_Air_Static_Pressure_Setpoint"));
	}

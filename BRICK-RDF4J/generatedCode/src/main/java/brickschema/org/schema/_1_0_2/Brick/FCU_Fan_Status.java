...
public  class FCU_Fan_Status implements IFCU_Fan_Status {

	IRI newInstance;
	
	public FCU_Fan_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#FCU_Fan_Status"));
	}

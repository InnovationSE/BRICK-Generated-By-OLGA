...
public  class Emergency_Power_Off_Switch implements IEmergency_Power_Off_Switch {

	IRI newInstance;
	
	public Emergency_Power_Off_Switch(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Emergency_Power_Off_Switch"));
	}

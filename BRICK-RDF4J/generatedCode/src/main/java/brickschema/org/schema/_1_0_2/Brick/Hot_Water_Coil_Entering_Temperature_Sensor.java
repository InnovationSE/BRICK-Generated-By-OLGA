...
public  class Hot_Water_Coil_Entering_Temperature_Sensor implements IHot_Water_Coil_Entering_Temperature_Sensor {

	IRI newInstance;
	
	public Hot_Water_Coil_Entering_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Hot_Water_Coil_Entering_Temperature_Sensor"));
	}

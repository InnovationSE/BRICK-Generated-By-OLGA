...
public  class Chilled_Water implements IChilled_Water {

	IRI newInstance;
	
	public Chilled_Water(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water"));
	}

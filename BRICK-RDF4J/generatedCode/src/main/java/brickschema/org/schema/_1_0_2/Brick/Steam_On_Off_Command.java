...
public  class Steam_On_Off_Command implements ISteam_On_Off_Command {

	IRI newInstance;
	
	public Steam_On_Off_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Steam_On_Off_Command"));
	}

...
import brickschema.org.schema._1_0_2.Brick.Smoke_Detected;
...
public  class Discharge_Air_Smoke_Detected implements IDischarge_Air_Smoke_Detected {

	IRI newInstance;
	
	public Discharge_Air_Smoke_Detected(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Discharge_Air_Smoke_Detected"));
	}

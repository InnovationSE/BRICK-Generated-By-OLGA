...
public  class Standby_Fan implements IStandby_Fan {

	IRI newInstance;
	
	public Standby_Fan(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Standby_Fan"));
	}

...
public  class Voltage implements IVoltage {
	...
	public Voltage(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Voltage"));
	}

...
public  class CO2_Level implements ICO2_Level {

	IRI newInstance;
	
	public CO2_Level(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CO2_Level"));
	}

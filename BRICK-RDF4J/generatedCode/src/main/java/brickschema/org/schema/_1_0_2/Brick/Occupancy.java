...
public  class Occupancy implements IOccupancy {
	...
	public Occupancy(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Occupancy"));
	}

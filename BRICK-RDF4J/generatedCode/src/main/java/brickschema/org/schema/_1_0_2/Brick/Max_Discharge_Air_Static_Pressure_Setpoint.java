...
public  class Max_Discharge_Air_Static_Pressure_Setpoint implements IMax_Discharge_Air_Static_Pressure_Setpoint {

	IRI newInstance;
	
	public Max_Discharge_Air_Static_Pressure_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Max_Discharge_Air_Static_Pressure_Setpoint"));
	}

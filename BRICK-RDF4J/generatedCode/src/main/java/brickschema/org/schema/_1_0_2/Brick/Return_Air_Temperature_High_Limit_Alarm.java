...
public  class Return_Air_Temperature_High_Limit_Alarm implements IReturn_Air_Temperature_High_Limit_Alarm {

	IRI newInstance;
	
	public Return_Air_Temperature_High_Limit_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Return_Air_Temperature_High_Limit_Alarm"));
	}

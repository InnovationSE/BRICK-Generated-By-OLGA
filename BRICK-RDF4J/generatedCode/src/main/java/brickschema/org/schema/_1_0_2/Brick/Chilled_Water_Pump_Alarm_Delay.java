...
import brickschema.org.schema._1_0_2.Brick.Alarm_Delay;
...
public  class Chilled_Water_Pump_Alarm_Delay implements IChilled_Water_Pump_Alarm_Delay {

	IRI newInstance;
	
	public Chilled_Water_Pump_Alarm_Delay(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Pump_Alarm_Delay"));
	}

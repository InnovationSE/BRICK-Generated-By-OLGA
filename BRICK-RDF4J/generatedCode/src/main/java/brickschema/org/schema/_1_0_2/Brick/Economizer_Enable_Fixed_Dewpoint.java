...
public  class Economizer_Enable_Fixed_Dewpoint implements IEconomizer_Enable_Fixed_Dewpoint {

	IRI newInstance;
	
	public Economizer_Enable_Fixed_Dewpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Enable_Fixed_Dewpoint"));
	}

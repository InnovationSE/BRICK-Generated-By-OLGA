...
public  class Supply_Air_Temperature_Reset_Differential implements ISupply_Air_Temperature_Reset_Differential {

	IRI newInstance;
	
	public Supply_Air_Temperature_Reset_Differential(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Supply_Air_Temperature_Reset_Differential"));
	}

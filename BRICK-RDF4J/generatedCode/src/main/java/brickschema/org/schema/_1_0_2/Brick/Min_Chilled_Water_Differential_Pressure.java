...
public  class Min_Chilled_Water_Differential_Pressure implements IMin_Chilled_Water_Differential_Pressure {

	IRI newInstance;
	
	public Min_Chilled_Water_Differential_Pressure(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Min_Chilled_Water_Differential_Pressure"));
	}

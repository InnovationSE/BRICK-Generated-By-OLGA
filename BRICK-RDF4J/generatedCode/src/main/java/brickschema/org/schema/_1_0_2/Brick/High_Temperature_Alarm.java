...
public  class High_Temperature_Alarm implements IHigh_Temperature_Alarm {

	IRI newInstance;
	
	public High_Temperature_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#High_Temperature_Alarm"));
	}

...
public  class Boiler_Start_Stop_Status implements IBoiler_Start_Stop_Status {

	IRI newInstance;
	
	public Boiler_Start_Stop_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Boiler_Start_Stop_Status"));
	}

...
public  class Chilled_Water_Differential_Pressure_Load_Shed_Status implements IChilled_Water_Differential_Pressure_Load_Shed_Status {

	IRI newInstance;
	
	public Chilled_Water_Differential_Pressure_Load_Shed_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Chilled_Water_Differential_Pressure_Load_Shed_Status"));
	}

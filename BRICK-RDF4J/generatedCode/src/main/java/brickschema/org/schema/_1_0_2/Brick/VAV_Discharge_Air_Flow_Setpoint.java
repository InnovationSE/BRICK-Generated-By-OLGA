...
public  class VAV_Discharge_Air_Flow_Setpoint implements IVAV_Discharge_Air_Flow_Setpoint {

	IRI newInstance;
	
	public VAV_Discharge_Air_Flow_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#VAV_Discharge_Air_Flow_Setpoint"));
	}

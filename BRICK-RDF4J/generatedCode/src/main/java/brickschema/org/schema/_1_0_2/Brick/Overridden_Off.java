...
public  class Overridden_Off implements IOverridden_Off {

	IRI newInstance;
	
	public Overridden_Off(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Overridden_Off"));
	}

...
public  class Emergency_Power_Off implements IEmergency_Power_Off {

	IRI newInstance;
	
	public Emergency_Power_Off(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Emergency_Power_Off"));
	}

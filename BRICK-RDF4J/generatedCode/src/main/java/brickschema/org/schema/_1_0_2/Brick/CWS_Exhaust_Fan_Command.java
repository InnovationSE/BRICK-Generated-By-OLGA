...
public  class CWS_Exhaust_Fan_Command implements ICWS_Exhaust_Fan_Command {

	IRI newInstance;
	
	public CWS_Exhaust_Fan_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CWS_Exhaust_Fan_Command"));
	}

...
public  class Hot_Water_Valve_Command implements IHot_Water_Valve_Command {

	IRI newInstance;
	
	public Hot_Water_Valve_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Hot_Water_Valve_Command"));
	}

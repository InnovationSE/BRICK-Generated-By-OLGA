...
public  class AHU_Supply_Air_Temperature_Reset_High_Setpoint implements IAHU_Supply_Air_Temperature_Reset_High_Setpoint {

	IRI newInstance;
	
	public AHU_Supply_Air_Temperature_Reset_High_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Supply_Air_Temperature_Reset_High_Setpoint"));
	}

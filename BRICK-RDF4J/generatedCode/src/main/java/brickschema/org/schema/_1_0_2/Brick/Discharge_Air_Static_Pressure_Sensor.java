...
public  class Discharge_Air_Static_Pressure_Sensor implements IDischarge_Air_Static_Pressure_Sensor {

	IRI newInstance;
	
	public Discharge_Air_Static_Pressure_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Discharge_Air_Static_Pressure_Sensor"));
	}

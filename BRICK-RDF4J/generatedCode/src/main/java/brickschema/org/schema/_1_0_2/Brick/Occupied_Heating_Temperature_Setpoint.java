...
public  class Occupied_Heating_Temperature_Setpoint implements IOccupied_Heating_Temperature_Setpoint {

	IRI newInstance;
	
	public Occupied_Heating_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Occupied_Heating_Temperature_Setpoint"));
	}

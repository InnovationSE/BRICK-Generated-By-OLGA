...
import brickschema.org.schema._1_0_2.Brick.Air_Grains;
...
public  class Return_Air_Grains implements IReturn_Air_Grains {

	IRI newInstance;
	
	public Return_Air_Grains(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Return_Air_Grains"));
	}

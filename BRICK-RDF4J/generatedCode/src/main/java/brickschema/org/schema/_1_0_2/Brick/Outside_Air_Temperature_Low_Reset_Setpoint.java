...
public  class Outside_Air_Temperature_Low_Reset_Setpoint implements IOutside_Air_Temperature_Low_Reset_Setpoint {

	IRI newInstance;
	
	public Outside_Air_Temperature_Low_Reset_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Outside_Air_Temperature_Low_Reset_Setpoint"));
	}

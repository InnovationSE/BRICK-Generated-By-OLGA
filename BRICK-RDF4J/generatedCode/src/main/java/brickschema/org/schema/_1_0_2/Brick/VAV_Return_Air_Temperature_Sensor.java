...
public  class VAV_Return_Air_Temperature_Sensor implements IVAV_Return_Air_Temperature_Sensor {

	IRI newInstance;
	
	public VAV_Return_Air_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#VAV_Return_Air_Temperature_Sensor"));
	}

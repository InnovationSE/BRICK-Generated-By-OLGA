...
public  class Exhaust_Fan_Disable_Command implements IExhaust_Fan_Disable_Command {

	IRI newInstance;
	
	public Exhaust_Fan_Disable_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Exhaust_Fan_Disable_Command"));
	}

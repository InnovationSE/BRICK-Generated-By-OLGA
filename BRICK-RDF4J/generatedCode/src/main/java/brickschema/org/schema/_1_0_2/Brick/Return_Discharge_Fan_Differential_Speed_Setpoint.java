...
public  class Return_Discharge_Fan_Differential_Speed_Setpoint implements IReturn_Discharge_Fan_Differential_Speed_Setpoint {
	...
	public Return_Discharge_Fan_Differential_Speed_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Return_Discharge_Fan_Differential_Speed_Setpoint"));
	}

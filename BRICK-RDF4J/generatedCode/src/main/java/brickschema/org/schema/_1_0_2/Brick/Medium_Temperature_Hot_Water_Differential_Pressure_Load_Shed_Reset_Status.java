...
public  class Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Reset_Status implements IMedium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Reset_Status {

	IRI newInstance;
	
	public Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Reset_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Medium_Temperature_Hot_Water_Differential_Pressure_Load_Shed_Reset_Status"));
	}

...
public  class Heating_Request_Setpoint implements IHeating_Request_Setpoint {

	IRI newInstance;
	
	public Heating_Request_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Heating_Request_Setpoint"));
	}

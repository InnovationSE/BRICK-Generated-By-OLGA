...
public  class Hot_Water_Flow_Meter implements IHot_Water_Flow_Meter {

	IRI newInstance;
	
	public Hot_Water_Flow_Meter(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Hot_Water_Flow_Meter"));
	}

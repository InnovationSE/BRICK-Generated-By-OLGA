...
public  class Return_Fan_Start_Stop_Status implements IReturn_Fan_Start_Stop_Status {

	IRI newInstance;
	
	public Return_Fan_Start_Stop_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Return_Fan_Start_Stop_Status"));
	}

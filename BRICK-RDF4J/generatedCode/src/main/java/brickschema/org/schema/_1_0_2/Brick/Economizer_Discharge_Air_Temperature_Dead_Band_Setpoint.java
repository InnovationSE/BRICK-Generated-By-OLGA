...
public  class Economizer_Discharge_Air_Temperature_Dead_Band_Setpoint implements IEconomizer_Discharge_Air_Temperature_Dead_Band_Setpoint {

	IRI newInstance;
	
	public Economizer_Discharge_Air_Temperature_Dead_Band_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Discharge_Air_Temperature_Dead_Band_Setpoint"));
	}

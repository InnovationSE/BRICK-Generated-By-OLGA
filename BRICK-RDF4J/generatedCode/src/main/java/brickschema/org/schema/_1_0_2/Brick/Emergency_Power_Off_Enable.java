...
public  class Emergency_Power_Off_Enable implements IEmergency_Power_Off_Enable {

	IRI newInstance;
	
	public Emergency_Power_Off_Enable(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Emergency_Power_Off_Enable"));
	}

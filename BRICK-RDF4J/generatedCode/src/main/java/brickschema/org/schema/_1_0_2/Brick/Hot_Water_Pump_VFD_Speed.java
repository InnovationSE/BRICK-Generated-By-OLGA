...
public  class Hot_Water_Pump_VFD_Speed implements IHot_Water_Pump_VFD_Speed {

	IRI newInstance;
	
	public Hot_Water_Pump_VFD_Speed(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Hot_Water_Pump_VFD_Speed"));
	}

...
public  class Heat_Exchanger_Start_Stop_Command implements IHeat_Exchanger_Start_Stop_Command {

	IRI newInstance;
	
	public Heat_Exchanger_Start_Stop_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Heat_Exchanger_Start_Stop_Command"));
	}

...
public  class DemandResponse_Load_Shed_Command implements IDemandResponse_Load_Shed_Command {
	...
	public DemandResponse_Load_Shed_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#DemandResponse_Load_Shed_Command"));
	}

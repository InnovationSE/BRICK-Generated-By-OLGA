...
public  class Air_Temperature_High_Reset implements IAir_Temperature_High_Reset {

	IRI newInstance;
	
	public Air_Temperature_High_Reset(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Air_Temperature_High_Reset"));
	}

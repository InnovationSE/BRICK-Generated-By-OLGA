...
public  class CWS_Discharge_Water_Temperature_Setpoint implements ICWS_Discharge_Water_Temperature_Setpoint {

	IRI newInstance;
	
	public CWS_Discharge_Water_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CWS_Discharge_Water_Temperature_Setpoint"));
	}

...
public  class Max_Chilled_Water_Differential_Pressure_Setpoint implements IMax_Chilled_Water_Differential_Pressure_Setpoint {

	IRI newInstance;
	
	public Max_Chilled_Water_Differential_Pressure_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Max_Chilled_Water_Differential_Pressure_Setpoint"));
	}

...
public  class AHU_Off_LED implements IAHU_Off_LED {

	IRI newInstance;
	
	public AHU_Off_LED(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Off_LED"));
	}

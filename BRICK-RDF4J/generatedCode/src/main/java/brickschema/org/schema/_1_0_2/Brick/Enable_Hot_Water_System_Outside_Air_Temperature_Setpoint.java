...
public  class Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint implements IEnable_Hot_Water_System_Outside_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint"));
	}

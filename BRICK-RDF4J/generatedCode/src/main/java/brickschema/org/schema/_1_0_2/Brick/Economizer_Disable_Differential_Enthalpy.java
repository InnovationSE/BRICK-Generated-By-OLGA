...
public  class Economizer_Disable_Differential_Enthalpy implements IEconomizer_Disable_Differential_Enthalpy {
	...
	public Economizer_Disable_Differential_Enthalpy(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Disable_Differential_Enthalpy"));
	}

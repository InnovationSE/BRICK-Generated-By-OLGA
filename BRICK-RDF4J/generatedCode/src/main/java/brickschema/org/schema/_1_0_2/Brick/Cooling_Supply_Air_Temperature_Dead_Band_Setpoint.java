...
public  class Cooling_Supply_Air_Temperature_Dead_Band_Setpoint implements ICooling_Supply_Air_Temperature_Dead_Band_Setpoint {

	IRI newInstance;
	
	public Cooling_Supply_Air_Temperature_Dead_Band_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Cooling_Supply_Air_Temperature_Dead_Band_Setpoint"));
	}

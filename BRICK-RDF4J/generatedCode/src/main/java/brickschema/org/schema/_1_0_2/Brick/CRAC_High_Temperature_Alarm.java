...
public  class CRAC_High_Temperature_Alarm implements ICRAC_High_Temperature_Alarm {

	IRI newInstance;
	
	public CRAC_High_Temperature_Alarm(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CRAC_High_Temperature_Alarm"));
	}

...
public  class Effective_Heating_Temperature implements IEffective_Heating_Temperature {

	IRI newInstance;
	
	public Effective_Heating_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Effective_Heating_Temperature"));
	}

...
public  class AHU_Min_Supply_Air_Temperature_Setpoint implements IAHU_Min_Supply_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public AHU_Min_Supply_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Min_Supply_Air_Temperature_Setpoint"));
	}

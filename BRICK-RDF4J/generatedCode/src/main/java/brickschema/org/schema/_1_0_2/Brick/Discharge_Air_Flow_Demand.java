...
public  class Discharge_Air_Flow_Demand implements IDischarge_Air_Flow_Demand {

	IRI newInstance;
	
	public Discharge_Air_Flow_Demand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Discharge_Air_Flow_Demand"));
	}

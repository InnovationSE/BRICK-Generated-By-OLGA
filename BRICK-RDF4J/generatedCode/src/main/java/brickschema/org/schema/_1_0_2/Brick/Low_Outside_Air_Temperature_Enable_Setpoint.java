...
public  class Low_Outside_Air_Temperature_Enable_Setpoint implements ILow_Outside_Air_Temperature_Enable_Setpoint {

	IRI newInstance;
	
	public Low_Outside_Air_Temperature_Enable_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Low_Outside_Air_Temperature_Enable_Setpoint"));
	}

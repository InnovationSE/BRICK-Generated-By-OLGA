...
public  class Static_Pressure_Min_Setpoint implements IStatic_Pressure_Min_Setpoint {

	IRI newInstance;
	
	public Static_Pressure_Min_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Static_Pressure_Min_Setpoint"));
	}

...
public  class Economizer_Enable_Fixed_Temperature implements IEconomizer_Enable_Fixed_Temperature {

	IRI newInstance;
	
	public Economizer_Enable_Fixed_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Economizer_Enable_Fixed_Temperature"));
	}

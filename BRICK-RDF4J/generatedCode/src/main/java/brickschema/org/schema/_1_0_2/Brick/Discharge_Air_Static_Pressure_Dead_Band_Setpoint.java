...
public  class Discharge_Air_Static_Pressure_Dead_Band_Setpoint implements IDischarge_Air_Static_Pressure_Dead_Band_Setpoint {

	IRI newInstance;
	
	public Discharge_Air_Static_Pressure_Dead_Band_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Discharge_Air_Static_Pressure_Dead_Band_Setpoint"));
	}

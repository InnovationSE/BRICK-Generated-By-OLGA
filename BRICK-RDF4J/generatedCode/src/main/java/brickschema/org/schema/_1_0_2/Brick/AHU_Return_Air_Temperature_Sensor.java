...
import brickschema.org.schema._1_0_2.Brick.Return_Air_Temperature_Sensor;
...
public  class AHU_Return_Air_Temperature_Sensor implements IAHU_Return_Air_Temperature_Sensor {

	IRI newInstance;
	
	public AHU_Return_Air_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Return_Air_Temperature_Sensor"));
	}

...
public  class VAV_Supply_Air_Temperature_Sensor implements IVAV_Supply_Air_Temperature_Sensor {

	IRI newInstance;
	
	public VAV_Supply_Air_Temperature_Sensor(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#VAV_Supply_Air_Temperature_Sensor"));
	}

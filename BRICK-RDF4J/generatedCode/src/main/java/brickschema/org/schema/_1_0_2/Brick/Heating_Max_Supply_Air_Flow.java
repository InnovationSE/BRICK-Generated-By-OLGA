...
public  class Heating_Max_Supply_Air_Flow implements IHeating_Max_Supply_Air_Flow {

	IRI newInstance;
	
	public Heating_Max_Supply_Air_Flow(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Heating_Max_Supply_Air_Flow"));
	}

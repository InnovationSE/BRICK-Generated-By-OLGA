...
public  class Supply_Air_Temperature_Sensor implements ISupply_Air_Temperature_Sensor {
	...
	public Supply_Air_Temperature_Sensor(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Supply_Air_Temperature_Sensor"));
	}

...
public  class CRAC_On_Off_Status implements ICRAC_On_Off_Status {

	IRI newInstance;
	
	public CRAC_On_Off_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CRAC_On_Off_Status"));
	}

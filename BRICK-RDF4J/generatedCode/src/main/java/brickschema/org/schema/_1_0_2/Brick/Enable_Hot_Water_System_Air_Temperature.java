...
import brickschema.org.schema._1_0_2.Brick.Hot_Water_System_Enable;
...
public  class Enable_Hot_Water_System_Air_Temperature implements IEnable_Hot_Water_System_Air_Temperature {

	IRI newInstance;
	
	public Enable_Hot_Water_System_Air_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Enable_Hot_Water_System_Air_Temperature"));
	}

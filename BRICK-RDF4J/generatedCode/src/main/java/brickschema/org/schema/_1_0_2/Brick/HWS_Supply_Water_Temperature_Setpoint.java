...
public  class HWS_Supply_Water_Temperature_Setpoint implements IHWS_Supply_Water_Temperature_Setpoint {

	IRI newInstance;
	
	public HWS_Supply_Water_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#HWS_Supply_Water_Temperature_Setpoint"));
	}

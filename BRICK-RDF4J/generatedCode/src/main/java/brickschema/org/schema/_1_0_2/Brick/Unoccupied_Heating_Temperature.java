...
public  class Unoccupied_Heating_Temperature implements IUnoccupied_Heating_Temperature {

	IRI newInstance;
	
	public Unoccupied_Heating_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Unoccupied_Heating_Temperature"));
	}

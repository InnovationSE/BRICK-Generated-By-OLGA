...
public  class CWS_Chilled_Water_Pump_Command implements ICWS_Chilled_Water_Pump_Command {

	IRI newInstance;
	
	public CWS_Chilled_Water_Pump_Command(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#CWS_Chilled_Water_Pump_Command"));
	}

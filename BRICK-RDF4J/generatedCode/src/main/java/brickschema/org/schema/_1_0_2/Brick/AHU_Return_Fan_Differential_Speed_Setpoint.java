...
public  class AHU_Return_Fan_Differential_Speed_Setpoint implements IAHU_Return_Fan_Differential_Speed_Setpoint {

	IRI newInstance;
	
	public AHU_Return_Fan_Differential_Speed_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_Return_Fan_Differential_Speed_Setpoint"));
	}

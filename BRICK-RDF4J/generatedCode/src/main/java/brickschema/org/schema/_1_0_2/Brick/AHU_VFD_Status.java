...
public  class AHU_VFD_Status implements IAHU_VFD_Status {

	IRI newInstance;
	
	public AHU_VFD_Status(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#AHU_VFD_Status"));
	}

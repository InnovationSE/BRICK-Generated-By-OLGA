...
public  class Domestic_Hot_Water_System_Start_Stop implements IDomestic_Hot_Water_System_Start_Stop {

	IRI newInstance;
	
	public Domestic_Hot_Water_System_Start_Stop(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Domestic_Hot_Water_System_Start_Stop"));
	}

...
public  class Mixed_Air_Temperature_Setpoint implements IMixed_Air_Temperature_Setpoint {
	...
	public Mixed_Air_Temperature_Setpoint(String namespace, String instanceId) {
		...
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Mixed_Air_Temperature_Setpoint"));
	}

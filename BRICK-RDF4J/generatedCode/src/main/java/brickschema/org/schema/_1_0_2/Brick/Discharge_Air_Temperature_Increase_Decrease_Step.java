...
public  class Discharge_Air_Temperature_Increase_Decrease_Step implements IDischarge_Air_Temperature_Increase_Decrease_Step {

	IRI newInstance;
	
	public Discharge_Air_Temperature_Increase_Decrease_Step(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Discharge_Air_Temperature_Increase_Decrease_Step"));
	}

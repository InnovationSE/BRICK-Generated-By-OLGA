...
public  class Open_Heating_Valve_Air_Temperature implements IOpen_Heating_Valve_Air_Temperature {

	IRI newInstance;
	
	public Open_Heating_Valve_Air_Temperature(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Open_Heating_Valve_Air_Temperature"));
	}

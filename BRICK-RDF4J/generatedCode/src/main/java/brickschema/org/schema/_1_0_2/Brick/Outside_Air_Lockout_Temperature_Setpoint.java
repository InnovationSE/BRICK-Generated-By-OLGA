...
public  class Outside_Air_Lockout_Temperature_Setpoint implements IOutside_Air_Lockout_Temperature_Setpoint {

	IRI newInstance;
	
	public Outside_Air_Lockout_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Outside_Air_Lockout_Temperature_Setpoint"));
	}

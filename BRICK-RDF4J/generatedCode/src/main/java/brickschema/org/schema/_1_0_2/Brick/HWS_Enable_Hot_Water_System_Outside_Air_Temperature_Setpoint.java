...
import brickschema.org.schema._1_0_2.Brick.Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint;
...
public  class HWS_Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint implements IHWS_Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint {

	IRI newInstance;
	
	public HWS_Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#HWS_Enable_Hot_Water_System_Outside_Air_Temperature_Setpoint"));
	}

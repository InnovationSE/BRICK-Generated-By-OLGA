...
public  class Heating_Demand implements IHeating_Demand {

	IRI newInstance;
	
	public Heating_Demand(String namespace, String instanceId) {
		super();
		newInstance = GLOBAL.factory.createIRI(namespace, instanceId);
		GLOBAL.model.add(newInstance, RDF.TYPE, GLOBAL.factory.createIRI("https://brickschema.org/schema/1.0.2/Brick#Heating_Demand"));
	}

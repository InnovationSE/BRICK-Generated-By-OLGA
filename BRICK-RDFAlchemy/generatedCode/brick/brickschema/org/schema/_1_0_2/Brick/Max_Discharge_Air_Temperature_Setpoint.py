...
class Max_Discharge_Air_Temperature_Setpoint(Discharge_Air_Temperature_Setpoint,Supply_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Max_Discharge_Air_Temperature_Setpoint

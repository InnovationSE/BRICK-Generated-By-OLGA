...
class AHU_Supply_Fan_VFD_Speed_Command(AHU_VFD_Speed_Command,Supply_Fan_VFD_Speed_Command,AHU_Discharge_Fan_Command,Discharge_Fan_VFD_Speed_Command,AHU_Supply_Fan_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Fan_VFD_Speed_Command

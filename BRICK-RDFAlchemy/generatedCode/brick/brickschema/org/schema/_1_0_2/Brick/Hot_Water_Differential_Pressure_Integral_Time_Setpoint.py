...
class Hot_Water_Differential_Pressure_Integral_Time_Setpoint(Hot_Water_Differential_Pressure_Setpoint,Differential_Pressure_Integral_Time_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Hot_Water_Differential_Pressure_Integral_Time_Setpoint

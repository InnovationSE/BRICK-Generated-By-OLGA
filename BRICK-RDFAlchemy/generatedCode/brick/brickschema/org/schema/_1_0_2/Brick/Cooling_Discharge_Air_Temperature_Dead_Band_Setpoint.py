...
class Cooling_Discharge_Air_Temperature_Dead_Band_Setpoint(Dead_Band_Setpoint,Supply_Air_Temperature_Cooling_Setpoint,Discharge_Air_Temperature_Cooling_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Cooling_Discharge_Air_Temperature_Dead_Band_Setpoint

...
class Exhaust_Air_Static_Pressure_Dead_Band_Setpoint(Exhaust_Air_Static_Pressure_Setpoint,Static_Pressure_Dead_Band_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Exhaust_Air_Static_Pressure_Dead_Band_Setpoint

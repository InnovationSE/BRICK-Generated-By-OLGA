...
class Discharge_Air_Temperature_High_Limit_Alarm(High_Temperature_Alarm,Discharge_Air,Supply_Air):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Air_Temperature_High_Limit_Alarm

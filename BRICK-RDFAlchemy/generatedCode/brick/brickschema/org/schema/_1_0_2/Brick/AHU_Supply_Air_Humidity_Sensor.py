...
class AHU_Supply_Air_Humidity_Sensor(Supply_Air_Humidity_Sensor,Discharge_Air_Humidity_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Air_Humidity_Sensor

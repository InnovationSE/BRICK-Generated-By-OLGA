...
class Discharge_Air_Temperature_Reset_High_Setpoint(Reset_Setpoint,Discharge_Air_Temperature_Setpoint,Supply_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Air_Temperature_Reset_High_Setpoint

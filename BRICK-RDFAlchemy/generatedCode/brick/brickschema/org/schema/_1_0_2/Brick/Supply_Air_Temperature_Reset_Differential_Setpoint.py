...
class Supply_Air_Temperature_Reset_Differential_Setpoint(Supply_Air_Temperature_Setpoint,Temperature_Differential_Reset_Setpoint,Discharge_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Temperature_Reset_Differential_Setpoint

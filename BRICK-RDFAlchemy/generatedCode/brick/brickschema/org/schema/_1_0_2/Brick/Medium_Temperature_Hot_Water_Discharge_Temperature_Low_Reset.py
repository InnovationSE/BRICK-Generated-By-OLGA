...
class Medium_Temperature_Hot_Water_Discharge_Temperature_Low_Reset(Medium_Temperature_Hot_Water_Discharge_Temperature,Low_Temperature,Temperature_Low):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Medium_Temperature_Hot_Water_Discharge_Temperature_Low_Reset

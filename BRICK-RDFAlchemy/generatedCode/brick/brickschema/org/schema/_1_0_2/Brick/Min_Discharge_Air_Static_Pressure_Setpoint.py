...
class Min_Discharge_Air_Static_Pressure_Setpoint(Discharge_Air_Static_Pressure_Setpoint,Supply_Air_Static_Pressure_Setpoint,Static_Pressure_Min_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Min_Discharge_Air_Static_Pressure_Setpoint

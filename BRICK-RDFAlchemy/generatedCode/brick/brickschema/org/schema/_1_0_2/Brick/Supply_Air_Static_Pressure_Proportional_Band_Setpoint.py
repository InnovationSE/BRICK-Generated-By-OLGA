...
class Supply_Air_Static_Pressure_Proportional_Band_Setpoint(Supply_Air_Static_Pressure_Setpoint,Discharge_Air_Static_Pressure_Setpoint,Proportional_Band_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Static_Pressure_Proportional_Band_Setpoint

...
class Discharge_Fan_Start_Stop_Status(Supply_Fan_Status,Discharge_Fan_Status,Fan_Start_Stop_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Fan_Start_Stop_Status

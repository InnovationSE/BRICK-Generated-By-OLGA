...
class AHU_Lowest_Zone_Temperature_Sensor(Lowest_Zone_Temperature_Sensor,Coldest_Zone_Temperature_Sensor,AHU_Zone_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Lowest_Zone_Temperature_Sensor

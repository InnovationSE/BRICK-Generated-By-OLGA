...
class Discharge_Fan_VFD_Speed_Status(Discharge_Fan_Status,Supply_Fan_Status,VFD_Speed_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Fan_VFD_Speed_Status

...
class VAV_Discharge_Air_Flow_Sensor(Discharge_Air_Flow_Sensor,Supply_Air_Flow_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Discharge_Air_Flow_Sensor

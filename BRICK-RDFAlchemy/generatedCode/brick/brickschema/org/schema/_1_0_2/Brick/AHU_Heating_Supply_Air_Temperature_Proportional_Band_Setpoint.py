...
class AHU_Heating_Supply_Air_Temperature_Proportional_Band_Setpoint(AHU_Supply_Air_Temperature_Heating_Setpoint,Heating_Supply_Air_Temperature_Proportional_Band_Setpoint,AHU_Discharge_Air_Temperature_Heating_Setpoint,Heating_Discharge_Air_Temperature_Proportional_Band_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Heating_Supply_Air_Temperature_Proportional_Band_Setpoint

...
class Hot_Water_Supply_Temperature_Sensor(Supply_Water_Temperature_Sensor,Water_Supply_Temperature_Sensor,Water_Discharge_Temperature_Sensor,Hot_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Hot_Water_Supply_Temperature_Sensor

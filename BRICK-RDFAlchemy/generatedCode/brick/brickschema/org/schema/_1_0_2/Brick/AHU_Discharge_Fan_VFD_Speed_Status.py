...
class AHU_Discharge_Fan_VFD_Speed_Status(Supply_Fan_VFD_Speed_Status,AHU_VFD_Status,AHU_Supply_Fan_Status,AHU_Discharge_Fan_Status,Discharge_Fan_VFD_Speed_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Fan_VFD_Speed_Status

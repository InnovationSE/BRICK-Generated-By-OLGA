...
class AHU_Discharge_Air_Temperature_Heating_Setpoint(AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint,Supply_Air_Temperature_Heating_Setpoint,Discharge_Air_Temperature_Heating_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Temperature_Heating_Setpoint

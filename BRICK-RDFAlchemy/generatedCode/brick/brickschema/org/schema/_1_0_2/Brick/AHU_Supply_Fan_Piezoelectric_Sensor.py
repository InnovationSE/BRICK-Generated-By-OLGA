...
class AHU_Supply_Fan_Piezoelectric_Sensor(Supply_Fan_Piezoelectric_Sensor,Discharge_Fan_Piezoelectric_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Fan_Piezoelectric_Sensor

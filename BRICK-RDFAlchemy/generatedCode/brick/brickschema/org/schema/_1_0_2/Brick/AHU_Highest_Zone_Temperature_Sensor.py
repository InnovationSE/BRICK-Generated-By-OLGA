...
class AHU_Highest_Zone_Temperature_Sensor(AHU_Zone_Temperature_Sensor,Warmest_Zone_Temperature_Sensor,Highest_Zone_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Highest_Zone_Temperature_Sensor

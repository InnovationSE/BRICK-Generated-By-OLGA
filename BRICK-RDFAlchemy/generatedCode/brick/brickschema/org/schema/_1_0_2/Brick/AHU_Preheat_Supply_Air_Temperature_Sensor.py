...
class AHU_Preheat_Supply_Air_Temperature_Sensor(AHU_Supply_Air_Temperature_Sensor,Preheat_Supply_Air_Temperature_Sensor,Preheat_Discharge_Air_Temperature_Sensor,AHU_Discharge_Air_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Preheat_Supply_Air_Temperature_Sensor

...
class AHU_Supply_Fan_VFD_Speed_Sensor(Discharge_Fan_VFD_Speed_Sensor,Supply_Fan_VFD_Speed_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Fan_VFD_Speed_Sensor

...
class AHU_Discharge_Air_Static_Pressure_Sensor(Discharge_Air_Static_Pressure_Sensor,AHU_Static_Pressure_Sensor,Supply_Air_Static_Pressure_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Static_Pressure_Sensor

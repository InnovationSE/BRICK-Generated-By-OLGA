...
class Cooling_Supply_Air_Temperature_Proportional_Band_Setpoint(Supply_Air_Temperature_Cooling_Setpoint,Proportional_Band_Setpoint,Discharge_Air_Temperature_Cooling_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Cooling_Supply_Air_Temperature_Proportional_Band_Setpoint

...
class AHU_Max_Discharge_Air_Temperature_Setpoint(Max_Supply_Air_Temperature_Setpoint,AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint,Max_Discharge_Air_Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Max_Discharge_Air_Temperature_Setpoint

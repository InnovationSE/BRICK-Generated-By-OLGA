...
class AHU_Cooling_Discharge_Air_Temperature_Proportional_Band_Setpoint(Cooling_Supply_Air_Temperature_Proportional_Band_Setpoint,AHU_Supply_Air_Temperature_Cooling_Setpoint,Cooling_Discharge_Air_Temperature_Proportional_Band_Setpoint,AHU_Discharge_Air_Temperature_Cooling_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Cooling_Discharge_Air_Temperature_Proportional_Band_Setpoint

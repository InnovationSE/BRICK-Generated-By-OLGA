...
class Discharge_Air_Flow_Reset_Low_Setpoint(Discharge_Air,Discharge_Air_Flow_Reset_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Air_Flow_Reset_Low_Setpoint

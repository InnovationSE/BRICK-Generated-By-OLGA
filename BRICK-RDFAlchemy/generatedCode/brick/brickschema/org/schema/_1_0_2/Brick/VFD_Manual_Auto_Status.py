...
class VFD_Manual_Auto_Status(Hand_Auto_Status,Manual_Auto_Status,VFD_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VFD_Manual_Auto_Status

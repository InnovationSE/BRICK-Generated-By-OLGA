...
class AHU_Economizer_Discharge_Air_Temperature_Proportional_Band_Setpoint(Economizer_Discharge_Air_Temperature_Proportional_Band_Setpoint,AHU_Discharge_Air_Temperature_Setpoint,AHU_Supply_Air_Temperature_Setpoint,Economizer_Supply_Air_Temperature_Proportional_Band_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Economizer_Discharge_Air_Temperature_Proportional_Band_Setpoint

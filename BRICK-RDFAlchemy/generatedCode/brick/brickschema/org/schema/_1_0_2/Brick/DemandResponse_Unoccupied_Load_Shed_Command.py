...
class DemandResponse_Unoccupied_Load_Shed_Command(DemandResponse_Load_Shed_Command,Unoccupied_Load_Shed_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').DemandResponse_Unoccupied_Load_Shed_Command

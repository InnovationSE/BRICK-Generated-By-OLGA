...
class VAV_Occupied_Cooling_Min_Supply_Air_Flow_Setpoint(VAV_Cooling_Min_Supply_Air_Flow_Setpoint,Occupied_Cooling_Discharge_Air_Flow_Setpoint,VAV_Occupied_Cooling_Supply_Air_Flow_Setpoint,VAV_Occupied_Cooling_Discharge_Air_Flow_Setpoint,Occupied_Cooling_Min_Discharge_Air_Flow_Setpoint,Occupied_Cooling_Min_Supply_Air_Flow_Setpoint,VAV_Cooling_Min_Discharge_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Occupied_Cooling_Min_Supply_Air_Flow_Setpoint

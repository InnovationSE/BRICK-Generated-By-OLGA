...
class Water_System_DI_Water_Level_Sensor(DI_Water_Level_Sensor,Deionised_Water_Level_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Water_System_DI_Water_Level_Sensor

...
class AHU_Exhaust_Fan_VFD_Speed_Command(Exhaust_Fan_VFD_Speed_Command,AHU_VFD_Speed_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Exhaust_Fan_VFD_Speed_Command

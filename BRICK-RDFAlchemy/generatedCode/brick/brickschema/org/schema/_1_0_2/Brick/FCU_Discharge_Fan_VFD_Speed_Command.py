...
class FCU_Discharge_Fan_VFD_Speed_Command(Supply_Fan_VFD_Speed_Command,FCU_VFD_Speed_Command,Discharge_Fan_VFD_Speed_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').FCU_Discharge_Fan_VFD_Speed_Command

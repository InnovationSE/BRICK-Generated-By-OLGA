...
class Hot_Water_Static_Pressure_Setpoint(Static_Pressure_Setpoint,Hot_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Hot_Water_Static_Pressure_Setpoint

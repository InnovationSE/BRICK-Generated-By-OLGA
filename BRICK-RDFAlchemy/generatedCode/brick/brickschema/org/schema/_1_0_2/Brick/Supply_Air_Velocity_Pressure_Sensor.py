...
class Supply_Air_Velocity_Pressure_Sensor(Velocity_Pressure_Sensor,Supply_Air,Discharge_Air):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Velocity_Pressure_Sensor

...
class Discharge_Fan_VFD_Speed_Command(VFD_Speed_Command,Supply_Fan_Command,Discharge_Fan_Command):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Fan_VFD_Speed_Command

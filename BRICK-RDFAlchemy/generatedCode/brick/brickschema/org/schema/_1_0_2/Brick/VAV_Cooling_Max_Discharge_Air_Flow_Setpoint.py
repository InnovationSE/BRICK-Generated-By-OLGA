...
class VAV_Cooling_Max_Discharge_Air_Flow_Setpoint(VAV_Supply_Air_Flow_Setpoint,VAV_Discharge_Air_Flow_Setpoint,Cooling_Max_Supply_Air_Flow_Setpoint,Cooling_Discharge_Air_Flow_Setpoint,Cooling_Max_Discharge_Air_Flow_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').VAV_Cooling_Max_Discharge_Air_Flow_Setpoint

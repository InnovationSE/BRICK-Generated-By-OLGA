...
class Low_Temperature_Alarm_Setpoint(Low_Temperature_Alarm,Temperature_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Low_Temperature_Alarm_Setpoint

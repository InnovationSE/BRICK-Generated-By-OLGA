...
class AHU_Heating_Request_Setpoint(Heating_Demand_Setpoint,Demand_Setpoint,Heating_Request_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Heating_Request_Setpoint

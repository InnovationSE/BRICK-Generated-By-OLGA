...
class Discharge_Air_Damper_Max_Position_Setpoint(Discharge_Air,Damper_Position_Setpoint,Supply_Air):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Discharge_Air_Damper_Max_Position_Setpoint

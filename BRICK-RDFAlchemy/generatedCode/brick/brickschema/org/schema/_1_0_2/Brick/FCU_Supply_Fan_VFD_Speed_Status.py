...
class FCU_Supply_Fan_VFD_Speed_Status(Discharge_Fan_VFD_Speed_Status,FCU_Fan_Status,Supply_Fan_VFD_Speed_Status):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').FCU_Supply_Fan_VFD_Speed_Status

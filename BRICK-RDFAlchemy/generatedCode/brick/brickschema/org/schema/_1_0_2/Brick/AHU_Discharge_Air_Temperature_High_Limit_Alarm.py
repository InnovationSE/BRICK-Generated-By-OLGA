...
class AHU_Discharge_Air_Temperature_High_Limit_Alarm(Supply_Air_Temperature_High_Limit_Alarm,Discharge_Air_Temperature_High_Limit_Alarm):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Temperature_High_Limit_Alarm

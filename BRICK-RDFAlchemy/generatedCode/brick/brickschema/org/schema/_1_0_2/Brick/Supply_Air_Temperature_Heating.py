...
class Supply_Air_Temperature_Heating(Supply_Air_Temperature,Heating_Temperature):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Air_Temperature_Heating

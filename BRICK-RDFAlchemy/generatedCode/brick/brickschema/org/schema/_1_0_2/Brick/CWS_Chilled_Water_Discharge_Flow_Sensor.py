...
class CWS_Chilled_Water_Discharge_Flow_Sensor(Chilled_Water_Supply_Flow_Sensor,Chilled_Water_Discharge_Flow_Sensor,Supply_Water_Flow_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').CWS_Chilled_Water_Discharge_Flow_Sensor

...
class Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint(Discharge_Water_Temperature_Setpoint,Medium_Temperature_Hot_Water,Hot_Water_Supply_Temperature_High_Reset_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Medium_Temperature_Hot_Water_Discharge_Temperature_High_Reset_Setpoint

...
class High_Temperature_Hot_Water_Supply_Temperature_Sensor(Hot_Water_Discharge_Temperature_Sensor,Hot_Water_Supply_Temperature_Sensor,High_Temperature_Hot_Water):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').High_Temperature_Hot_Water_Supply_Temperature_Sensor

...
class Heating_Supply_Air_Temperature_Dead_Band_Setpoint(Dead_Band_Setpoint,Discharge_Air_Temperature_Heating_Setpoint,Supply_Air_Temperature_Heating_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Heating_Supply_Air_Temperature_Dead_Band_Setpoint

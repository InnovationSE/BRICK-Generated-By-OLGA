...
class AHU_Supply_Air_Smoke_Detected_Alarm(Discharge_Air_Smoke_Detected_Alarm,Supply_Air_Smoke_Detected_Alarm):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Supply_Air_Smoke_Detected_Alarm

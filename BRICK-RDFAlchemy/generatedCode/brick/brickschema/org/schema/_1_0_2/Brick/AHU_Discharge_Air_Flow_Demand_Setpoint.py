...
class AHU_Discharge_Air_Flow_Demand_Setpoint(Supply_Air_Flow_Demand_Setpoint,Discharge_Air_Flow_Demand_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').AHU_Discharge_Air_Flow_Demand_Setpoint

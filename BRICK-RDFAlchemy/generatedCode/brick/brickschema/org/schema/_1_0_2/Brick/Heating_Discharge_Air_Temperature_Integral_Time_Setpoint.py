...
class Heating_Discharge_Air_Temperature_Integral_Time_Setpoint(Supply_Air_Temperature_Heating_Setpoint,Integral_Time_Setpoint,Discharge_Air_Temperature_Heating_Setpoint):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Heating_Discharge_Air_Temperature_Integral_Time_Setpoint

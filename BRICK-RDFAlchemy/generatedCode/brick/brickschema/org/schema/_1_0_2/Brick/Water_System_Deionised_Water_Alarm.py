...
class Water_System_Deionised_Water_Alarm(DI_Water_Alarm,Deionised_Water_Alarm):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Water_System_Deionised_Water_Alarm

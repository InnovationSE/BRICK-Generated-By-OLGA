...
class HWS_Heat_Exchanger_Discharge_Water_Temperature_Sensor(Supply_Water_Temperature_Sensor,Heat_Exchanger_Supply_Water_Temperature_Sensor,Heat_Exchanger_Discharge_Water_Temperature_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').HWS_Heat_Exchanger_Discharge_Water_Temperature_Sensor

...
class Supply_Fan_Air_Flow_Sensor(Supply_Air_Flow_Sensor,Discharge_Air_Flow_Sensor,Fan_Air_Flow_Sensor):
    rdf_type = Namespace('https://brickschema.org/schema/1.0.2/Brick#').Supply_Fan_Air_Flow_Sensor
